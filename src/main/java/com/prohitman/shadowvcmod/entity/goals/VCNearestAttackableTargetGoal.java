...
/**
*   Created a NearestAttackableTargetGoal copy to allow
*   for follow range modification of the entity's target
 * */
public class VCNearestAttackableTargetGoal<T extends LivingEntity> extends TargetGoal {
    private static final int DEFAULT_RANDOM_INTERVAL = 10;
    protected final Class<T> targetType;
    protected final int randomInterval;
    /**The configurable follow range for the specific target*/
    ...
    /** Removed getNearestPlayer method call to allow for follow range usage */
